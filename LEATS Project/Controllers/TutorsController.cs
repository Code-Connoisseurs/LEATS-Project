...
namespace LEATS_Project.Controllers
{
    public class TutorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TutorID,StudentID,Experience,Qualification,Tut_StreetName,RatePerHour,Status,TotalRating,NoOfSessions")] Tutor tutor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TutorID,StudentID,Experience,Qualification,Tut_StreetName,RatePerHour,Status,TotalRating,NoOfSessions")] Tutor tutor)
        {
            if (ModelState.IsValid)
            {
